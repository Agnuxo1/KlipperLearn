> Historical unposted collaboration plan, preserved from the pre-launch source.
> Read COMMUNITY.md and the current ledger for current release and submission status.
