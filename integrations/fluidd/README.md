# Fluidd: restricted camera interoperability

Keep Fluidd and its normal printer controls. KlipperLearn can supply its existing
...
appropriate maintenance time to install it, configure a camera in Fluidd:
...
Native Fluidd GUI acceptance remains a separate operator test.
